...
export default function UploadVideo({ video, categories, games }) {
      ...
      <div className="lg:flex lg:space-x-10">
        ...
        <div className="p-4 sm:p-8 bg-white w-full dark:bg-zinc-900 shadow sm:rounded-lg">
          <header className="mb-5">
            ...
            <PrimaryButton onClick={(e) => Inertia.visit(route("videos.list"))}>
              {__("<< Back to Videos")}
            </PrimaryButton>
          </header>
          ...
          <form onSubmit={submit} encType="multipart/form-data">
            ...
            <div className="mb-5">
              <InputLabel for="game" value={__("Game")} />
              <CustomSelect
                className={"md:w-1/2"}
                name="game_id"
                options={games}
            ...
            <div className="flex justify-between items-center">
              <PrimaryButton processing={processing || spinner}>
                {video.id === null ? __("Save Video") : __("Update Video")}
              </PrimaryButton>
            </div>
