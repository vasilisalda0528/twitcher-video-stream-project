    ...
    <div className="fixed inset-x-0 z-10 bg-violet-800 border-b-2 border-violet-800 dark:bg-zinc-900 dark:border-b-2 dark:border-zinc-800">
      ...
      >
        <div className="p-3">
          ...
          />
          {results.length === 0 && (
            <div className="dark:text-white">{__("No results")}</div>
          )}
        ...
        <div className="flex items-center">
            ...
            <>
              <Dropdown>
                ...
                <Dropdown.Content>
                  ...
                  {auth.user.is_streamer === "yes" && (
                    <Dropdown.Link href={route("channel.settings")}>
                      {__("Channel Settings")}
                    </Dropdown.Link>
                  )}

                  <Dropdown.Link href={route("notifications.inbox")}>
                    {__("Notifications")}
                  ...
                  {auth.user.is_streamer === "yes" && (
                    <Dropdown.Link href={route("payout.withdraw")}>
                      {__("Withdraw")}
                    </Dropdown.Link>
                  )}

                  {auth.user.is_streamer === "yes" && (
                    <Dropdown.Link href={route("membership.set-tiers")}>
                      {__("Membership Tiers")}
                    </Dropdown.Link>
                  )}

                  {auth.user.is_streamer === "yes" && (
                    <Dropdown.Link href={route("videos.list")}>
                      {__("Upload Videos")}
                    </Dropdown.Link>
                  )}

                  <Dropdown.Link href={route("videos.ordered")}>
                    {__("My Videos")}
                  </Dropdown.Link>
                  ...
                  {auth.user.is_streamer === "yes" && (
                    <Dropdown.Link href={route("mySubscribers")}>
                      {__("My Subscribers")}
                    </Dropdown.Link>
                  )}

                  <Dropdown.Link href={route("profile.followings")}>
                    {__("My Followings")}
                  </Dropdown.Link>
                  <Dropdown.Link href={route("mySubscriptions")}>
                    {__("My Subscriptions")}
                  </Dropdown.Link>
          ...
          <Dropdown>
            ...
            <Dropdown.Content>
              ...
              <Dropdown.Link href={route("home")}>{__("Home")}</Dropdown.Link>
