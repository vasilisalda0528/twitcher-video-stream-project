...
!(function () {
    ...
    const Z = (e) => e.dom.nodeName.toLowerCase(),
        ...
        ge = (e) =>
            W(e.dom.attributes, (e, t) => ((e[t.name] = t.value), e), {}),
        he = (e) => {
        ...
        pe = {
            ...
            fromDom: he,
            fromPoint: (e, t, o) =>
                C.from(e.dom.elementFromPoint(t, o)).map(he),
        },
        we = (e, t) => {
            const o = e.dom;
        ...
        ve = (e, t) => {
            ...
            return be(o)
                ? C.none()
                : C.from(o.querySelector(e)).map(pe.fromDom);
        },
        ye = (e, t) => e.dom === t.dom,
        xe = (e, t) => {
            const o = e.dom,
    ...
    const at = (e, t, o) => {
        ...
        Nt = (e, t) => Et(e, t, 1),
        Bt = (e) =>
            ae("col")(e) ? Et(e, "span", 1) > 1 : Nt(e, "colspan") > 1,
        zt = (e) => Nt(e, "rowspan") > 1,
    ...
    const To = () => So(),
        ...
        An = (e, t, o) => {
            const n = ((r = e),
            C.from(r.dom.parentElement).map(pe.fromDom)).getOrThunk(() =>
                tt(Se(e))
            );
            var r;
            return (t(e) / o(n)) * 100;
        ...
        er = (e, t) => () =>
            et(e) ? t(e) : parseFloat(Ot(e, "width").getOr("0")),
        tr = (e) => {
    ...
    var Pr = [
        ...
        Fr = () => ({
            ...
            property: g({
                ...
                isEmptyTag: (e) =>
                    !!ne(e) && D(["br", "img", "hr", "input"], Z(e)),
                isNonEditable: (e) =>
                    ne(e) && "false" === de(e, "contenteditable"),
            }),
            eq: ye,
            is: Ce,
        });
    const Hr = (e, t, o, n) => {
        ...
        ts = (e, t, o) =>
            t.length <= 1
                ? C.none()
                : Xr(e, o.firstSelectedSelector, o.lastSelectedSelector).map(
                      (e) => ({ bounds: e, cells: t })
                  ),
        os = {
        ...
        cs = (e, t) => {
            e.on("BeforeGetContent", (t) => {
                ...
                if (!0 === t.selection) {
                    const t = ((e) =>
                        z(as(e), (e) => we(e, os.selectedSelector)))(e);
                    t.length >= 1 && o(t);
                }
            }),
                ...
                s = (e) =>
                    j(e, (e) =>
                        E(
                            e.cells,
                            (e) => (
                                Fs(e.element, "span", e.colspan, 1), e.element
                            )
                        )
                    ),
                l = (t, o) => {
        ...
        ul = (e, t, o) =>
            z(o, (o) => o >= e.column && o <= Mo(t[0]) + e.column),
        fl = (e, t, o, n, r) => {
            ((e, t, o, n) => {
                t > 0 &&
                    t < e[0].cells.length &&
                    N(e, (e) => {
                        ...
                        for (
                            ...
                            Ao(e, t + s, Ke(l, !0, e.cells[t + s].isLocked)),
                                s++;
                    });
            })(t, e, r, n.cell);
            const s = ll(o, t),
        ...
        _l = (e, t = Wl) => {
            const o = (o) => {
                if (Al(o))
                    return zl((r = { element: o }).element)
                        ? e.colgroup(r)
                        : e.row(r);
                {
                    const r = o,
                        s = ((t) => (Bl(t.element) ? e.col(t) : e.cell(t)))(
                            t(r)
                        );
        ...
        la = (e) => (t, o) =>
            Qs(t, o).filter((o) => !(e ? oa : na)(t, o.cells)),
        aa = Ml("th"),
        ca = Ml("td"),
        ia = Js(
            (e, t, o, n) => {
        ...
        fa = Js(
            ...
            (e, t) =>
                Zs(e, t).map((t) => ({ details: t, pixelDelta: -ra(e, t) })),
            ta,
            $l,
            _l
        ),
            ...
            return Xs(o, t)
                .bind((e) => {
                    const t = e[e.length - 1],
                        ...
                        s = M(
                            E(o.all, (e) =>
                                z(e.cells, (e) => e.column >= n && e.column < r)
                            )
                        );
                    return ks(s);
                })
        ...
        cc = (e, t) =>
            0 === e.length
                ? t
                : A(e, (e, t) => lc.from(t).fold(g(0), h, h) + e, 0),
        ic = (e, t) =>
            lc.from(e).fold(
                g(e),
                (e) => e + t + "px",
    ...
    const Dc = "x-tinymce/dom-table-",
        ...
        Ic = (e, t) => {
            const o = Or(e),
                ...
                i = () =>
                    l((t, o) =>
                        ((e, t, o) => {
                            ...
                            t,
                            ns(as(e), t, o),
                            Tr(f, pe.fromDom(e.getDoc()), C.none())
                        )
                    ),
                m = () =>
                    l((t, o) =>
                ...
                g = (e) => (t, o) =>
                    ((e, t) => (X(e, t) ? C.from(e.type) : C.none()))(
                        o,
                        "type"
                    ).each((t) => {
                        c(e(t), o.no_events);
    ...
    const Zc = (e, t, o, n) => ({
        ...
        Bi = (e, t, o) => {
            return ((n = t),
            (r = Fl),
            lt((e, t) => t(e), at, n, r, undefined)).fold(y, (t) =>
                Ei(e, t).exists((e) =>
                    ((e, t) =>
                        e.left < t.left ||
        ...
        Ai = (e, t, o, n, r) =>
            0 === r
                ...
                ? ((e, t, o, n, r) => Ai(e, t, o, t.move(n, 5), r))(
                      e,
                      t,
                      o,
                      n,
            ...
            dt(n, "td,th", t).bind((n) =>
                dt(n, "table", t).bind((s) =>
                    ((e, t) =>
                        at(
                            e,
                            (e) => Re(e).exists((e) => ye(e, t)),
                            void 0
                        ).isSome())(r, s)
                        ? ((e, t, o) =>
                              _i(e, t, o).bind((n) =>
                                  Mi(e, t, n.element, n.offset, o, 20).map(
                                      e.fromSitus
                                  )
                              ))(e, t, o).bind((e) =>
        ...
        Hi = (e, t, o, n, r, s) =>
            s(n, t).orThunk(() =>
                Fi(e, t, o, n, r).map((e) => {
                    const t = e.range;
                    return Hc(
                        C.some(oi(t.start, t.soffset, t.finish, t.foffset)),
                        !0
                    );
                })
            ),
            ...
            dt(e, "tr", t).bind((e) =>
                dt(e, "table", t).bind((o) => {
                    ...
                    return ye(e, n[n.length - 1])
                        ? ((e, t, o) => fi(gi, e, (e) => gr(e).isSome(), o))(
                              o,
                              0,
                              t
                          ).map((e) => Hc(C.some(oi(e, 0, e, 0)), !0))
                        : C.none();
                })
            ),
        $i = (e, t, o, n, r, s, l) =>
        ...
        rm = {
            ...
            exact: nm.exact,
            exactFromRange: (e) =>
                nm.exact(e.start, e.soffset, e.finish, e.foffset),
            getWin: (e) => {
                const t = ((e) =>
                    e.match({
        ...
        wm = (e) => ({
            elementFromPoint: (t, o) =>
                pe.fromPoint(pe.fromDom(e.document), t, o),
                        ...
                        e.on("keydown", (o) => {
                            ...
                            const r = e.selection.getRng(),
                                ...
                                a = rn(
                                    tm,
                                    om
                                )(pe.fromDom(e.selection.getStart()));
                            c
        ...
        _m = (e, t) => {
            ...
            o.length > 0 &&
                ((e) => {
                    throw new Error(
                        "Unsupported keys for object: " + Lm(e).join(", ")
                    );
                })(o);
        },
        Mm = (e) =>
            ...
            return (
                s.events.adjustHeight.bind((e) => {
                    ...
                    ((e, t, o, n) => {
                        const r = Uo(e),
                            s = ((e, t, o) =>
                                Zn(e, t, o, Hn, (e) => e.getOrThunk(Lt)))(
                                r,
                                e,
                                n
                            ),
                            l = E(s, (e, n) =>
                                o === n ? Math.max(t + e, Lt()) : e
                            ),
                            a = Ol(r, l),
                            c = ((e, t) =>
                                E(e.all, (e, o) => ({
